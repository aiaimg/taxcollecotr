...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--username", type=str, help="Username to create notifications for", default="admin")
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"✓ Created welcome notification: {notif1.id}"))
        ...
        self.stdout.write(self.style.SUCCESS(f"✓ Created system notification: {notif2.id}"))
