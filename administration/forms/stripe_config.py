...
class StripeConfigForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'publishable_key': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'pk_live_... or pk_test_...'}),
            ...
            'success_url': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://example.com/payments/success/'}),
            'cancel_url': forms.URLInput(attrs={'class': 'form-control', 'placeholder': 'https://example.com/payments/cancel/'}),
        }
