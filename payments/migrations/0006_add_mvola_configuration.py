...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('payments', '0005_paiementtaxe_mvola_customer_msisdn_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['is_active'], name='payments_mv_is_acti_112a4e_idx'), models.Index(fields=['is_enabled'], name='payments_mv_is_enab_3ad7c3_idx'), models.Index(fields=['environment'], name='payments_mv_environ_40e41c_idx')],
            },
        ),
    ]
