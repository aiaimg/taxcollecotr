...
class MobileMoneyService:
    ...
    def validate_phone_number(self, phone: str, operator: str) -> bool:
        ...
        if operator == 'mvola':
            ...
            return phone.startswith('032') or phone.startswith('037') or phone.startswith('261032') or phone.startswith('261037')
    ...
    def initiate_payment(self, amount: float, phone: str, reference: str, description: str = '') -> Dict[str, Any]:
        ...
        try:
            if not self.validate_phone_number(phone, 'mvola'):
                return {
                    'success': False,
                    'error': _('Numéro de téléphone MVola invalide')
                }
            ...
            if response.status_code == 200:
                ...
                return {
                    'success': False,
                    'error': _('Erreur lors de l\'initiation du paiement MVola')
                }
            ...
            return {
                'success': False,
                'error': _('Erreur de connexion au service MVola')
            }
        except Exception as e:
            logger.error(f"MVola unexpected error: {str(e)}")
            return {
                'success': False,
                'error': _('Erreur inattendue lors du paiement MVola')
            }
    ...
    def check_payment_status(self, transaction_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {
                    'success': False,
                    'error': _('Impossible de vérifier le statut du paiement')
                }
    ...
    def initiate_payment(self, amount: float, phone: str, reference: str, description: str = '') -> Dict[str, Any]:
        ...
        try:
            if not self.validate_phone_number(phone, 'orange_money'):
                return {
                    'success': False,
                    'error': _('Numéro de téléphone Orange Money invalide')
                }
            ...
            return {
                'success': False,
                'error': _('Erreur lors du paiement Orange Money')
            }
    ...
    def initiate_payment(self, amount: float, phone: str, reference: str, description: str = '') -> Dict[str, Any]:
        ...
        try:
            if not self.validate_phone_number(phone, 'airtel_money'):
                return {
                    'success': False,
                    'error': _('Numéro de téléphone Airtel Money invalide')
                }
            ...
            return {
                'success': False,
                'error': _('Erreur lors du paiement Airtel Money')
            }
...
class PaymentServiceFactory:
    ...
    @staticmethod
    def initiate_payment(payment_method: str, amount: float, phone: str, reference: str, description: str = '') -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                'success': False,
                'error': _('Erreur lors de l\'initiation du paiement')
            }
